...
public class UnsupportedClassException extends RuntimeException {
    ...
    public UnsupportedClassException(String string) {
        super(string);
    }

    public UnsupportedClassException(Throwable thrwbl) {
        super(thrwbl);
    }

    public UnsupportedClassException(String string, Throwable thrwbl) {
        super(string, thrwbl);
    }
