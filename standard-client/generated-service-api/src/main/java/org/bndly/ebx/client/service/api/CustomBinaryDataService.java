...
public interface CustomBinaryDataService {
    ...
    BinaryData createAndUpload(BinaryData data) throws ClientException;

    BinaryData readByName(String name) throws ClientException;

    void upload(BinaryData data) throws ClientException;
}
