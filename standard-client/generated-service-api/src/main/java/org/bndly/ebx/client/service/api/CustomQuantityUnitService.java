...
import org.bndly.common.service.shared.api.DefaultValueSupportingService;
 ...
 * @author timopahrisch
 */
public interface CustomQuantityUnitService extends DefaultValueSupportingService<QuantityUnit> {

    QuantityUnit readById(long id) throws ClientException;
}
