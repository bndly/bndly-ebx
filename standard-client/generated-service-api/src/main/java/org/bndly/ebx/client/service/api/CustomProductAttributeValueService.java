...
public interface CustomProductAttributeValueService {

    ProductAttributeValue getAttributeValueByAttributeNameAndValue(String attributeName, String attributeValue) throws ClientException;
}
