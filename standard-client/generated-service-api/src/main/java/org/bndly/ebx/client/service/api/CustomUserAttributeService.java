...
public interface CustomUserAttributeService {

    UserAttribute readOrCreateUserAttribute(String name) throws ClientException, ReferenceBuildingException;

    UserAttribute readByName(String name) throws ClientException;

    UserAttribute readById(long id) throws ClientException;
}
