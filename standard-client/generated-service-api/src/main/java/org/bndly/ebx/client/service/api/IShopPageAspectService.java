 ...
 */
public interface IShopPageAspectService<PAGE, ASPECT> extends RegistrableService {
    static String NAME = "ShopPageAspectService";

    <A extends ASPECT> A getAspectByName(String aspectName);
