 ...
 */
public interface ExportEntityCollector<MODEL extends ExportEntity> {
	
	public static interface ExportEntityHandler<MODEL> {
		void handleExportEntity(MODEL entity) throws ExportServiceException;
	}
	
    void collect(ExportEntityHandler<MODEL> handler) throws ExportServiceException;
}
