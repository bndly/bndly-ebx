...
public interface TemplateSource {
   ...
   boolean store(String filename, String fileDir) throws IOException;
   boolean store(File file, String fileDir) throws IOException;
   boolean store(InputStream inputStream, String fileDir) throws IOException;
