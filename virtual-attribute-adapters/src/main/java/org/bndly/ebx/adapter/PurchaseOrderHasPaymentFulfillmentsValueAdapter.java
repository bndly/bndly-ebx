...
public class PurchaseOrderHasPaymentFulfillmentsValueAdapter extends AbstractPurchaseOrderHasSomethingValueAdapter implements VirtualAttributeAdapter<BooleanAttribute> {

	@Reference(target = "(service.pid=org.bndly.schema.beans.SchemaBeanFactory.ebx)")
	private SchemaBeanFactory schemaBeanFactory;

	public PurchaseOrderHasPaymentFulfillmentsValueAdapter() {
		super("hasPaymentFulfillments", PurchaseOrderPaymentFulfillment.class);
	}
