...
public class CartItemTaxableItemValueAdapter implements VirtualAttributeAdapter<DecimalAttribute> {
	...
	public boolean supports(DecimalAttribute attribute, NamedAttributeHolder holder) {
		return "taxableItemPriceNetto".equals(attribute.getName()) && SchemaInspectionUtil.isAssignableTo(holder, CartItem.class.getSimpleName());
	}

	@Override
	public Object read(DecimalAttribute attribute, Record r) {
		return schemaBeanFactory.getSchemaBean(CartItem.class, r).getPriceNow();
	}
