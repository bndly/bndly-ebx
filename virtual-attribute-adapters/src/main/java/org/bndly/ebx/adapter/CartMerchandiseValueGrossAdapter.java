...
public class CartMerchandiseValueGrossAdapter extends AbstractMerchandiseValueGrossAdapter<Cart, CartItem> {

	private static final PriceCallback<CartItem> GROSS = new PriceCallback<CartItem>() {
		@Override
		public BigDecimal getPrice(CartItem item) {
			return item.getPriceGrossNow();
		}
	};
	private static final PriceCallback<CartItem> NET = new PriceCallback<CartItem>() {
		@Override
		public BigDecimal getPrice(CartItem item) {
			return item.getPriceNow();
		}
	};
	...
	public CartMerchandiseValueGrossAdapter() {
		super(Cart.class.getSimpleName());
	}
	...
	@Override
	protected Iterable<CartItem> getMerchandiseItemsFromContainer(Cart container) {
		return container.getCartItems();
	}
