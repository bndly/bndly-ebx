...
public class LineItemTotalGrossValueAdapter implements VirtualAttributeAdapter<DecimalAttribute> {
	...
	public Object read(DecimalAttribute attribute, Record r) {
		...
		if (li.getQuantity() != null && li.getPriceGross() != null) {
			totalGross = li.getPriceGross().multiply(new BigDecimal(li.getQuantity()));
		}
		r.setAttributeValue(attribute.getName(), totalGross);
		return totalGross;
	}
