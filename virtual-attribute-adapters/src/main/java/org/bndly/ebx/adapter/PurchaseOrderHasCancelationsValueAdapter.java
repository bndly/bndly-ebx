...
public class PurchaseOrderHasCancelationsValueAdapter extends AbstractPurchaseOrderHasSomethingValueAdapter implements VirtualAttributeAdapter<BooleanAttribute> {

	@Reference(target = "(service.pid=org.bndly.schema.beans.SchemaBeanFactory.ebx)")
	private SchemaBeanFactory schemaBeanFactory;
	
	public PurchaseOrderHasCancelationsValueAdapter() {
		super("hasCancelations", PurchaseOrderCancelation.class);
	}
