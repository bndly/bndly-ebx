...
/**
 * Created by IntelliJ IDEA. User: borismatosevic Date: 14.05.13 Time: 15:38 To
 * change this template use File | Settings | File Templates.
 */
@Component(service = ExportMapper.class, immediate = true)
public class PreisRoboterExportMapper extends AbstractExportMapper<PreisRoboterEntity> implements ExportMapper<PreisRoboterEntity> {
	...
	public PreisRoboterExportMapper() {
	...
	@Override
	public PreisRoboterEntity toModel(Purchasable domainModel, UserPrice userPrice) {
		PreisRoboterEntity model = super.toModel(domainModel, userPrice);
