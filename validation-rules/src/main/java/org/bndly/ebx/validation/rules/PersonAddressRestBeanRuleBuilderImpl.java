...
@Component(service = {PersonAddressRestBeanRuleBuilderImpl.class, RestBeanRelatedRuleBuilder.class}, immediate = true)
public class PersonAddressRestBeanRuleBuilderImpl extends AddressRestBeanRuleBuilderImpl {
