...
import org.bndly.rest.beans.ebx.AvailabilityRegistrationRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class AvailabilityRegistrationRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<AvailabilityRegistrationRestBean> {
	...
	@Override
	public Class<AvailabilityRegistrationRestBean> getRestModelType() {
		return AvailabilityRegistrationRestBean.class;
	}
