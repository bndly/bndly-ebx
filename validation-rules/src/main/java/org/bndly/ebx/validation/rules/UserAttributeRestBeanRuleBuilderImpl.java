...
import org.bndly.rest.beans.ebx.UserAttributeRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class UserAttributeRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<UserAttributeRestBean> {
	...
	@Override
	public Class<UserAttributeRestBean> getRestModelType() {
		return UserAttributeRestBean.class;
	}
