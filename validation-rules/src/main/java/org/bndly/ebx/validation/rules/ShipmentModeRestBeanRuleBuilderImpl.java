...
import org.bndly.rest.beans.ebx.ShipmentModeRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class ShipmentModeRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<ShipmentModeRestBean> {
	...
	@Override
	public Class<ShipmentModeRestBean> getRestModelType() {
		return ShipmentModeRestBean.class;
	}
