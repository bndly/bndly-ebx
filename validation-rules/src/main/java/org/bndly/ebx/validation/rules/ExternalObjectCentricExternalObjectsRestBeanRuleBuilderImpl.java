...
public class ExternalObjectCentricExternalObjectsRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<ExternalObjectCentricExternalObjectListRestBean> {

	@Override
	protected void injectRules(RulesRestBean rules) {
		rules.add(RuleBuilder.buildNotEmptyRule("object"));
		rules.add(RuleBuilder.buildNotEmptyRule("type"));
	}

	@Override
	public Class<ExternalObjectCentricExternalObjectListRestBean> getRestModelType() {
		return ExternalObjectCentricExternalObjectListRestBean.class;
	}
