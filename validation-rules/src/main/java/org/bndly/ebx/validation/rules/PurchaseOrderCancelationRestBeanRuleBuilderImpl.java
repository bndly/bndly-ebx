...
import org.bndly.rest.beans.ebx.PurchaseOrderCancelationRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class PurchaseOrderCancelationRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<PurchaseOrderCancelationRestBean> {
	...
	@Override
	public Class<PurchaseOrderCancelationRestBean> getRestModelType() {
		return PurchaseOrderCancelationRestBean.class;
	}
