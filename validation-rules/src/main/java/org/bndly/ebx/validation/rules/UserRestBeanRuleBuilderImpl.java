...
import org.bndly.rest.beans.ebx.UserRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class UserRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<UserRestBean> {
	...
	@Override
	public Class<UserRestBean> getRestModelType() {
		return UserRestBean.class;
	}
