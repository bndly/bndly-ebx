...
public class CartRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<CartRestBean> {

	@Override
	protected void injectRules(RulesRestBean rules) {
		rules.add(RuleBuilder.buildNotEmptyRule("lastInteraction"));
		rules.add(RuleBuilder.buildNotEmptyRule("userIdentifier"));
	}

	@Override
	public Class<CartRestBean> getRestModelType() {
		return CartRestBean.class;
	}
