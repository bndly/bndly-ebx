...
public class PaymentConfigurationRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<PaymentConfigurationRestBean> {

	@Override
	protected void injectRules(RulesRestBean rules) {
		rules.add(RuleBuilder.buildNotEmptyRule("successLink"));
		rules.add(RuleBuilder.buildNotEmptyRule("failureLink"));
		rules.add(RuleBuilder.buildNotEmptyRule("cancelLink"));
	}

	@Override
	public Class<PaymentConfigurationRestBean> getRestModelType() {
		return PaymentConfigurationRestBean.class;
	}
