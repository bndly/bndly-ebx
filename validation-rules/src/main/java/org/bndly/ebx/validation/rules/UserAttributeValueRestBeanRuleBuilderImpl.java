...
import org.bndly.rest.beans.ebx.UserAttributeValueRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class UserAttributeValueRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<UserAttributeValueRestBean> {

	@Override
	protected void injectRules(RulesRestBean rules) {
		rules.add(RuleBuilder.buildNotEmptyRule("user"));
		rules.add(RuleBuilder.buildNotEmptyRule("attribute"));
	}

	@Override
	public Class<UserAttributeValueRestBean> getRestModelType() {
		return UserAttributeValueRestBean.class;
	}
