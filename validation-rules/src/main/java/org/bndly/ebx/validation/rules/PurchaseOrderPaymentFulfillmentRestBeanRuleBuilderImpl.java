...
import org.bndly.rest.beans.ebx.PurchaseOrderPaymentFulfillmentRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class PurchaseOrderPaymentFulfillmentRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<PurchaseOrderPaymentFulfillmentRestBean> {
	...
	@Override
	public Class<PurchaseOrderPaymentFulfillmentRestBean> getRestModelType() {
		return PurchaseOrderPaymentFulfillmentRestBean.class;
	}
