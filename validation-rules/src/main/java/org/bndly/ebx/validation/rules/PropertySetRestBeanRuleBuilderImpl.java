...
public class PropertySetRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<PropertySetRestBean> {
	...
	@Override
	public Class<PropertySetRestBean> getRestModelType() {
		return PropertySetRestBean.class;
	}
