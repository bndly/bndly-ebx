...
public class CheckoutRequestRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<CheckoutRequestRestBean> {

	@Override
	protected void injectRules(RulesRestBean rules) {
		rules.add(RuleBuilder.buildNotEmptyRule("order"));
		rules.add(RuleBuilder.buildNotEmptyRule("createdOn"));
	}

	@Override
	public Class<CheckoutRequestRestBean> getRestModelType() {
		return CheckoutRequestRestBean.class;
	}
