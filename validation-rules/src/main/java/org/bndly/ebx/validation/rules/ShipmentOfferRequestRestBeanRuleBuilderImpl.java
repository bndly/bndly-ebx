...
import org.bndly.rest.beans.ebx.ShipmentOfferRequestRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class ShipmentOfferRequestRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<ShipmentOfferRequestRestBean> {

	@Override
	protected void injectRules(RulesRestBean rules) {
		rules.add(RuleBuilder.buildNotEmptyRule("user"));
		rules.add(RuleBuilder.buildNotEmptyRule("cart"));
		rules.add(RuleBuilder.buildNotEmptyRule("currency"));
	}

	@Override
	public Class<ShipmentOfferRequestRestBean> getRestModelType() {
		return ShipmentOfferRequestRestBean.class;
	}
