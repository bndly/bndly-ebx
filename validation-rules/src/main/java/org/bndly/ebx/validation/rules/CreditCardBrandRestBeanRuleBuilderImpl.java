...
import org.bndly.rest.beans.ebx.CreditCardBrandRestBean;
import org.osgi.service.component.annotations.Component;

@Component(service = RestBeanRelatedRuleBuilder.class, immediate = true)
public class CreditCardBrandRestBeanRuleBuilderImpl extends AbstractRestBeanRelatedRuleBuilder<CreditCardBrandRestBean> {
	...
	@Override
	public Class<CreditCardBrandRestBean> getRestModelType() {
		return CreditCardBrandRestBean.class;
	}
