...
public interface ShipmentOfferBusinessProcessses {

    public ShipmentOfferRequest runListShipmentOffers(
			@ProcessVariable(name = "shipmentOfferRequest") ShipmentOfferRequest shipmentOfferRequest,
